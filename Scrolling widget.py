...
class ListFrame(ttk.Frame):
    def __init__(self, parent, text_data, item_height):
        ...
        self.scrollbary = ttk.Scrollbar(self, orient='vertical', command=self.canvas.yview)
        self.canvas.configure(yscrollcommand=self.scrollbary.set)
        self.scrollbary.place(relx=1, rely=0, relheight=1, anchor='ne')
