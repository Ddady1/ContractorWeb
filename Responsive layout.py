...
class App(ttk.Window):
    ...
    def create_large_layout(self):
        ...
        self.frame = ttk.Frame(self)
        self.frame.pack(expand=True, fill='both')
        ttk.Label(self.frame, text='Label 1', background='red').pack(expand=True, fill='both',side='left', padx=10, pady=5)
        ttk.Label(self.frame, text='Label 2', background='green').pack(expand=True, fill='both',side='left', padx=10, pady=5)
        ttk.Label(self.frame, text='Label 3', background='blue').pack(expand=True, fill='both',side='left', padx=10, pady=5)
        ttk.Label(self.frame, text='Label 4', background='yellow').pack(expand=True, fill='both',side='left', padx=10, pady=5)
