...
name_en = tk.Entry(root, width=35)
manuf_lb = tk.Label(root, text='Manufacturer:')
manuf_en = tk.Entry(root, width=40)
qty_lb = tk.Label(root, text='Quantity:')
qty_en = tk.Entry(root, width=10)


name_lb.grid(column=0, row=0, padx=5, pady=5)
name_en.grid(column=1, row=0)
manuf_lb.grid(column=2, row=0, padx=5, pady=5)
manuf_en.grid(column=3, row=0)
qty_lb.grid(column=4, row=0, padx=5, pady=5)
qty_en.grid(column=5, row=0)
